## Open mpv using hints
config.bind('<Ctrl-Shift-y>', 'hint links spawn --detach mpv --autofit=75% --force-window yes {hint-url}')
...
## Type: Font
# c.fonts.monospace = 'Tamzen, "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
